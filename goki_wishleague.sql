...
INSERT INTO `contacts` (`id`, `strName`, `strEmail`, `nPhone`, `strMessage`) VALUES
(1, 'Gabrielle Aoki', 'gmaoki@yahoo.com.br', '2367776619', 'Testing');
...
INSERT INTO `countries` (`id`, `strName`) VALUES
(1, 'Afghanistan'),
(2, 'Albania'),
(3, 'Algeria'),
(4, 'American Samoa'),
...
INSERT INTO `globals` (`id`, `strName`, `strValue`) VALUES
(1, 'logo', 'logo.png'),
(2, 'phone', '(604) 222 5555'),
(3, 'address', '570 Dunsmuir Street, Suite 600 - Vancouver, BC, Canada - V6B 1Y1'),
(4, 'facebook', 'wishleague'),
(5, 'instagram', 'wishleague'),
(6, 'twitter', 'wishleague');
...
CREATE TABLE `hospitals` (
  ...
  `nPhone` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `strBio` text COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `pages` (`id`, `strNav`, `strMainTitle`, `strMainContent`, `bMainPage`) VALUES
(1, 'Home', 'Home Title', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', 1),
(2, 'Hospitals', 'Hospitals Title', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', 1),
...
INSERT INTO `states` (`id`, `strName`, `nCountryID`) VALUES
...
--
ALTER TABLE `hospitals`
  ADD CONSTRAINT `hospitals_ibfk_1` FOREIGN KEY (`nProvinceID`) REFERENCES `states` (`id`);

--
-- Constraints for table `states`
--
ALTER TABLE `states`
  ADD CONSTRAINT `states_ibfk_1` FOREIGN KEY (`nCountryID`) REFERENCES `countries` (`id`);

--
-- Constraints for table `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`nProvinceID`) REFERENCES `states` (`id`);

--
-- Constraints for table `users_cms`
--
ALTER TABLE `users_cms`
  ADD CONSTRAINT `users_cms_ibfk_1` FOREIGN KEY (`nHospitalID`) REFERENCES `hospitals` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `wishes`
--
ALTER TABLE `wishes`
  ADD CONSTRAINT `wishes_ibfk_1` FOREIGN KEY (`nHospitalID`) REFERENCES `hospitals` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `wishes_ibfk_2` FOREIGN KEY (`nStatusID`) REFERENCES `status` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
COMMIT;
